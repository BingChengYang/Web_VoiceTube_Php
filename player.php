<?php
# Deal with GET, give back the caption to a specific video
if($_SERVER['REQUEST_METHOD'] == 'GET')
{
	try
	{
		# Retreive GET var in safe way
...
<html>
	...
	<body>
		...
		<div class = "top-area">
			<div class="container">
				<div class="col">
					<div class="vt-progress-nav white" id="progress">
						聽力
						<div class="vt-progress-nav-bar" ></div>
					</div>
				</div>
			</div>

			<div id="video-container" class="content-area container">
				<div class="row">
					<span class="player-section colwide col-xs-12 col-sm-12 col-md-12 col-lg-6"  id="muteYouTubeVideoPlayer">
						<script async src="https://www.youtube.com/iframe_api"></script>	
					</span>

					<span class="larger-section col-xs-0 col-sm-0 col-md-0 col-lg-1">
						<i id="fold-middle" class="fa-angle-double-right"></i>
						<!-- Must put after fold-middle to add listener -->
